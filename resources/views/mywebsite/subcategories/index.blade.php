                    ...
                    <div class="card-header">  
                     ...
                     subcategories
                       ...
                       <div class="float-right">
                             <a href="{{ route('mywebsite.subcategories.create') }}" class="btn btn-primary">Create </a>
         </div></div>
 <div class="card-body">
            ...
            <tbody>
                @foreach($types as $subcategory)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('mywebsite.subcategories.show', $subcategory) }}" class="btn btn-sm btn-primary">View</a>
                            <a href="{{ route('mywebsite.subcategories.edit', $subcategory) }}" class="btn btn-sm btn-success">Edit</a>
                            <form action="{{ route('mywebsite.subcategories.destroy', $subcategory) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
